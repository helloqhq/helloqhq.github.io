...
```html
<script
  src="https://fastly.jsdelivr.net/npm/admin-lte@4.0.0-beta3/dist/js/adminlte.min.js"
...
<link
  rel="stylesheet"
  href="https://fastly.jsdelivr.net/npm/admin-lte@4.0.0-beta3/dist/css/adminlte.min.css"
  crossorigin="anonymous"
/>
```
